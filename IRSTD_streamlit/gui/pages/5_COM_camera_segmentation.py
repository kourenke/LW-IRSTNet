...
class CameraDetectionPage:
    ...
    def show_video_frame(self, frame: cv2.Mat) -> None:
        ...
        st.image(new_frame, caption="Result Video", use_column_width=True)
    ...
    def show_page(self) -> None:
        ...
        video_capture.set(cv2.CAP_PROP_FRAME_WIDTH, 640)  # 1280 640
        video_capture.set(cv2.CAP_PROP_FRAME_HEIGHT, 512)  # 1024 512
        ...
        while video_capture.isOpened():
            ...
            if not success:
                is_recording = SessionState.set_var(**{"is_recording": False})
                break
